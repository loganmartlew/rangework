---
applyTo: "apps/mobile/androidApp/**/*.kt,apps/mobile/androidApp/**/*.kts,apps/mobile/androidApp/**/*.xml"
---
...
- When changing UI or ViewModel behavior, prefer extending tests under `apps/mobile/androidApp/src/test/java/com/loganmartlew/rangework/android` rather than introducing ad hoc manual-only behavior.
